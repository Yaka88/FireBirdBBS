...
char    Big5FromTxt[] = "发信人: ";
char    Big5BoardTxt[] = "信区: ";
char    Big5SubjectTxt[] = "标  题: ";
char    Big5OrganizationTxt[] = "发信站: ";
char    Big5PathTxt[] = "转信站: ";
char    Big5NCTUCSIETxt[] = "交大资工 News Server";
char    Big5ModerationTxt[] = "您的文章 \"%s\" 已经送往审核中. 请等待回覆.\n";
char    Big5bbslinkUsage1[] = "本程式要正常执行必须将以下档案置於 %s/innd 下:\n";
char    Big5bbslinkUsage2[] = "bbsname.bbs   设定贵站的 BBS ID (请尽量简短)\n";
char    Big5bbslinkUsage3[] = "nodelist.bbs  设定网路各 BBS 站的 ID, Address 和 fullname\n";
char    Big5bbslinkUsage4[] = "newsfeeds.bbs 设定网路信件的 newsgroup board nodelist ...\n";

char    GBFromTxt[] = "楷□□: ";
char    GBBoardTxt[] = "□□: ";
char    GBSubjectTxt[] = "梓  □: ";
char    GBOrganizationTxt[] = "楷□桴: ";
char    GBPathTxt[] = "□□桴: ";
char    GBNCTUCSIETxt[] = "蝠湮□驮 News Server";
char    GBModerationTxt[] = "蜡腔□□ \"%s\" □幂□厘机瞄□. □胀浑隙葡.\n";
char    GBbbslinkUsage1[] = "挂最□猁□都硒□斛□蔚□□紫偶离□ %s/innd □:\n";
char    GBbbslinkUsage2[] = "bbsname.bbs   □隅幛桴腔 BBS ID (□□讲□傻)\n";
char    GBbbslinkUsage3[] = "nodelist.bbs  □隅厍缭跪 BBS 桴腔 ID, Address 睿 fullname\n";
char    GBbbslinkUsage4[] = "newsfeeds.bbs □隅厍缭□璃腔 newsgroup board nodelist ...\n";
