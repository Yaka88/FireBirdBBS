...
int     line, mode;
{
/* Sonny.990608 –ﬁ∏¥÷ÿ∏¥ π”√ saveline  ±ª·∞—”©ƒª≈™¬“µƒŒ Ã‚ */
/* 		ƒø«∞ «”√Õ¡∑®¡∂∏÷µƒ∑Ω Ω–ﬁµƒ, ±»Ωœª® CPU “≤±»Ωœ’º memory */

	register struct screenline *bp = big_picture;
	static char linetmp[2][256];	/* ”√¿¥¥Ê»°±ª∏≤∏«µƒƒ«–– */
	static char linetmptmp[2][256];	/* ”√¿¥¥Ê»°÷ÿ∏¥±ª∏≤∏«µƒƒ«–– */
	static int savelinerecorder[2] = {0, 0};	/* º«“‰ «∑Ò±ª÷ÿ∏¥∏≤∏« */
	int     x, y;
	switch (mode) {
	case 0:
	case 2:
