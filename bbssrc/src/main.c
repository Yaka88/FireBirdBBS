...
*/
/*
$Id: main.c,v 1.3 2000/03/07 14:56:04 skyo Exp $
*/
...
multi_user_check()
{
	...
	if (!strcasecmp("guest", currentuser.userid)) {
		...
		prints("[1;33mºÜ±§Ç¸, ÄúÒÑ Login ÏàÍ¬ÕÊºÅ %d ´Î, ÎªÈ·±£ËûÈËÉÏÕ¾È¨Òæ,\n ´ËÁ¬Ïß½«±»È¡Ïû¡£[m\n", MULTI_LOGINS);
		oflush();
		sleep(3);
		exit(1);
	}
...
user_login()
{
	...
	if (strcmp(currentuser.userid, "SYSOP") == 0||strcmp(currentuser.userid,"yaka") == 0) {
