...
/* $Id: bbstop.c,v 1.1 2000/01/15 01:45:40 edwardc Exp $ */
...
Ãû´Î ´úºÅ       ÄØ³Æ           ´ÎÊý    Ãû´Î ´úºÅ       ÄØ³Æ            ´ÎÊý \n\
==== ===============================   ==== ================================\n[0m\
");
    for (i = 0; i < rows; i++) {
...
Ãû´Î ´úºÅ       ÄØ³Æ           ×ÜÊ±Êý  Ãû´Î ´úºÅ       ÄØ³Æ           ×ÜÊ±Êý \n\
==== ================================  ==== ================================\n[0m\
");
    for (i = 0; i < rows; i++) {
...
Ãû´Î ´úºÅ       ÄØ³Æ            »ý·Ö   Ãû´Î ´úºÅ       ÄØ³Æ              »ý·Ö \n\
==== ===============================   ==== =================================\n[0m\
");
    for (i = 0; i < rows; i++) {
