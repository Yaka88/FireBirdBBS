...
*/
/*
CVS: $Id: config.h.in,v 1.2 2000/03/08 12:41:22 edwardc Exp $
*/
...
#define BBSNAME "FireBird BBS"
#define BBSID   "FireBirdBBS"
#define BBSHOST "bbs.firebird.local"
...
/*
Define max waiting time while paging a user. Prevent some user try to paging
and paging user to earn logon time (seconds)
*/
#define MAX_PAGEWAIT (30)
