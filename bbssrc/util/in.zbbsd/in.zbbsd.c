...
/* 990609.edwardc what's "SECURE_BBSID" will do ?
   FB ϵ�е�Ԥ�谲װ����, bbs ����ʺ��ǲ����趨�����, ����ʹ����
   in.zbbsd/telnetd ����, bbs �ʺŲ�������������Ծ���ʧ��, NULL passwd
   Ҳ�������Щ��ȫ����, �򿪴�ѡ����, in.zbbsd ��������������� bbs �ʺ� */
...
#define PTYSIZ          2048    /* ���� pty ֮ buffer size */
#define NETSIZ          2048    /* ���� net ֮ buffer size */
...
/* sys/filio.h is BSD-specific, use sys/ioctl.h on Linux */
#include <sys/ioctl.h>
...
#define BANNER  "\r\nFirebird BBS 3.0 %s [bbsd ready]\r\n[1;36mBBS ��� [33m(1,10,15)[36m ���ӵ�ƽ������Ϊ[33m %s [36m(���� = %d) [%s] .[0m\r\n"

#else

#define BANNER  "\r\nFirebird BBS 3.0 ���� BBS ϵͳ [bbs.firebird.dhs.org]\r\n\n"
...
forever:
    ...
    if (pid > uptime)
    {
      ...
      uptime = pid + overload + 60;     /* ��ʱ���ڲ��ټ�� system load */
    }
#endif
