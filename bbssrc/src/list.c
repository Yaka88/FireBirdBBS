...
print_title()
{
	...
	docmdtitle((friendmode) ? "[�������б�]" : "[ʹ�����б�]",
		" ����[[1;32mt[m] ����[[1;32mm[m] ��ѶϢ[[1;32ms[m] ��,������[[1;32mo[m,[1;32md[m] ��˵����[[1;32m��[m,[1;32mRtn[m] �л�ģʽ[[1;32mf,i[m]���[[1;32mh[m]");
	update_endline();
}
print_title2()
{
...
print_user_info_title()
{
	...
	sprintf(title_str,
		...
		"���  ", "ʹ���ߴ���", field_2, "����", 'P',
		 /* ((HAS_PERM(PERM_SYSOP|PERM_SEECLOAK)) ? 'C' : ' ') */ 'M', "��̬",
...
int     allnum, pagenum;
{
	...
	case 'C':
		if (strcmp(currentuser.userid, user_record[allnum]->userid))
			return 0;
		strcpy(buf, "");
		getdata(BBS_PAGESIZE + 3, 0, "�任�س�: ", buf, NAMELEN, DOECHO, NA);
		if (buf[0] != '\0') {
...
int     star, curr;
{
	if (user_record[curr]->userid != NULL) {
		...
		move(t_lines - 1, 0);
		prints("[0;1;37;44m����[[1;32mt[37m] ����[[1;32mm[37m] ��ѶϢ[[1;32ms[37m] ��,������[[1;32mo[37m,[1;32md[37m] ѡ��ʹ����[[1;32m��[37m,[1;32m��[37m]�л�ģʽ[[1;32mf,i[37m] ���[[1;32mh[37m][m");
	}
}
do_query2(star, curr)
int     star, curr;
