...
*/
/*
$Id: bbs.c,v 1.3 2000/03/07 15:14:30 skyo Exp $
*/
...
char   *direct;
{
	...
	/* edwardc.991031 ÐÞÕý¿³ÎÄÕª²¢²»»á°Ñ .DIGEST ÖÐµÄ entry ¸ø¿³µô */
...
notepad()
{
	...
	if ((in = fopen(tmpname, "w")) != NULL) {
		...
		if (note1[0] != 'N' && note1[0] != 'n') {
			...
			fprintf(in, "[1;34m¡õ[44m¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ[36mËá[32mÌð[33m¿à[31mÀ±[37m°å[34m¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ¡õ[44m¡õ[m\n");
			fprintf(in, "[1;34m¡õ[32;44m %-48s[32mÔÚ [36m%.19s[32m Àë¿ªÊ±ÁôÏÂµÄ»°  [m\n", tmp, Ctime(&thetime));
			for (n = 0; n < i; n++) {
				if (note[n][0] == '\0')
					break;
				fprintf(in, "[1;34m¡õ[33;44m %-75.75s[1;34m[m \n", note[n]);
			}
			fprintf(in, "[1;34m¡õ[44m ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª [m \n");
