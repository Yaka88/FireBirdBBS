...
*/
/*
$Id: comm_lists.c,v 1.2 2000/02/17 15:19:03 edwardc Exp $
*/
...
int     x_state(), shownotepad(), x_userdefine(), x_csh();
...
int     wait_friend(), setguard();
int     t_query(), t_talk(), t_pager(), t_friend(), t_reject(), x_cloak();
int     ent_chat(), t_irc();

int 	x_love();//add by yaka
int	m_ordainBM();//add by yaka
