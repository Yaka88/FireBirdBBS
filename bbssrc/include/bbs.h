...
*/
/*
$Id: bbs.h,v 1.4 2000/02/14 06:05:50 edwardc Exp $
*/
...
#include "functions.h"			/* you can enable functions that you want */
  ...
  #define VERSION_ID "FIREBIRD 3.0"
#else
  #ifdef CVS
    #define VERSION_ID "FIREBIRD 3.0-CVS"
  #endif
  #ifdef RELDATE
    #define VERSION_ID "FB 3.0-"RELDATE
  #endif
#endif
...
#ifdef BIGGER_MOVIE
  #define MAXMOVIE			  8	   /* called "MAXnettyLN" prvious, "netty" is
  									  one of the CCU Firebird's father, but he's no
  									  such famous as SmallPig or others .. */
#else
...
#define MAIL_REPLY	0x20		//add by yaka
